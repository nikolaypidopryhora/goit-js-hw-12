import{a as b,S as v,i as M}from"./assets/vendor-09d7c26e.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();async function g(s,r){const o="https://pixabay.com",i="6515730-7e532fca90fe4fa55f1852c4d",t=`${o}/api/?`,a={key:i,q:s,image_type:"photo",orientation:"horizontal",safesearch:!0,page:r,per_page:15};return(await b.get(t,{params:a})).data}function y(s){return s.map(({webformatURL:r,largeImageURL:o,tags:i,likes:e,views:t,comments:a,downloads:p})=>`
        ...
        </li>`).join("")}function n(s){M.error({message:s,position:"topRight"})}const L=new v(".gallery a",{captionsData:"alt",captionDelay:250}),h=document.querySelector(".search"),l=document.querySelector(".gallery"),m=document.querySelector(".load-more-button"),c=document.querySelector(".loader");h.addEventListener("submit",E);m.addEventListener("click",$);let u,d=1,w;const P=15;async function E(s){if(s.preventDefault(),u=h.elements.search.value.trim(),!u){n("Empty input!");return}d=1,c.classList.remove("hidden"),f();try{const r=await g(u,d);r.totalHits?(l.innerHTML=y(r.hits),w=Math.ceil(r.totalHits/P),L.refresh()):(n("Sorry, there are no images matching your search query. Please try again!"),l.innerHTML=""),h.reset()}catch{n("Something went wrong!"),l.innerHTML="",c.classList.add("hidden")}c.classList.add("hidden"),S()}async function $(){f(),d+=1,c.classList.remove("hidden");try{const s=await g(u,d);l.insertAdjacentHTML("beforeend",y(s.hits)),L.refresh()}catch{n("Something went wrong!")}O(),S(),c.classList.add("hidden")}function q(){m.classList.remove("hidden")}function f(){m.classList.add("hidden")}function S(){d>=w?(f(),n("We're sorry, but you've reached the end of search results.")):q()}function O(){const s=l.firstElementChild.getBoundingClientRect().height;scrollBy({top:s*2+24,behavior:"smooth"})}
